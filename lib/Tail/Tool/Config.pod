...
This documentation refers to Tail::Tool::Config version 0.4.4

=head1 DESCRIPTION

The L<Tail::Tool> application sortres it's configuration in C<~/.tailtrc> it
allows the use of multiple seperate named configurations. Which you can
